      ...
      <main className={styles.container}>
        ...
        <div className={styles.orderDetail}>
          ...
          {order.shippingAddress && (
            <div className={styles.detailCard}>
              <div className={styles.detailHeader}>
                <h3 className={styles.detailTitle}>Alamat Pengiriman</h3>
              </div>
              <div className={styles.detailBody}>
                <div className={styles.detailRow}>
                  <span className={styles.detailLabel}>Nama Penerima</span>
                  <span className={styles.detailValue}>{order.shippingAddress.recipientName} - {order.shippingAddress.phone}</span>
                </div>
                <div className={styles.detailRow}>
                  <span className={styles.detailLabel}>Alamat</span>
                  <span className={styles.detailValue}>{order.shippingAddress.addressLine1}{order.shippingAddress.addressLine2 ? `, ${order.shippingAddress.addressLine2}` : ''}, {order.shippingAddress.city}, {order.shippingAddress.province} {order.shippingAddress.postalCode}</span>
                </div>
              </div>
            </div>
          )}
