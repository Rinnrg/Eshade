              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead style={{ backgroundColor: '#f9fafb', borderBottom: '1px solid #e5e7eb' }}>
                  <tr>
                    ...
                    <th style={{ padding: '0.75rem 1rem', textAlign: 'left', fontSize: '0.75rem', fontWeight: '600', color: '#6b7280', textTransform: 'uppercase' }}>Alamat</th>
                        ...
                        <td style={{ padding: '1rem', textAlign: 'left' }}>
                          {order.shippingAddress ? (
                            <button
                                ...
                                showAlert({
                                  ...
                                  message: (
                                    <dl>
                                      ...
                                      <dt>Alamat:</dt>
                                      <dd>{`${addr.addressLine1}${addr.addressLine2 ? `, ${addr.addressLine2}` : ''}, ${addr.city}, ${addr.province} ${addr.postalCode}`}</dd>
                                      <dt>No telepon:</dt>
                                      <dd>{addr.phone}</dd>
                                      {addr.latitude != null && addr.longitude != null && (
                                        <>
                                          <dt>Koordinat:</dt>
                                          <dd>{`${Number(addr.latitude).toFixed(6)}, ${Number(addr.longitude).toFixed(6)}`}</dd>
                                        </>
                                      )}
                                    </dl>
                                  ),
                              ...
                              style={{ padding: '0.35rem 0.6rem', borderRadius: '0.375rem', border: '1px solid #e5e7eb', background: '#fff', cursor: 'pointer', fontSize: '0.85rem' }}
                            >
                              Lihat
                            </button>
                          ) : (
