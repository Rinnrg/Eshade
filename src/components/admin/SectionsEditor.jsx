...
import { compressImageFile, cropImageToSquare } from '@src/lib/image-utils';
   ...
   const handleUploadImages = async (sectionIndex, fileList) => {
     ...
     try {
       ...
       const processed = await Promise.all(files.map(async (file) => {
         // First crop to centered square (1:1), then compress to limit
           ...
           <div key={index} className={styles.sectionItem}>
               ...
               <div className={styles.sectionActions}>
                 ...
                 <button
                   ...
                   onClick={() => showAlert({
                     type: 'confirm',
                     title: 'Hapus Section',
                     message: 'Apakah Anda yakin ingin menghapus section ini? Semua perubahan belum disimpan akan hilang.',
                     confirmText: 'Hapus',
                     cancelText: 'Batal',
                     showCancel: true,
             ...
             <div className={styles.sectionForm}>
               ...
               {sectionVisibility[index]?.showGambar && (
                 <div className={styles.formGroup}>
                  <label>Gambar (Upload — otomatis crop 1:1)</label>
                   ...
                   <small>Gambar akan otomatis di-crop menjadi rasio 1:1 saat diupload. Anda tetap bisa menyesuaikan crop secara manual dengan tombol "Crop".</small>
                     ...
                     <div className={styles.imageRow}>
                       {section.gambar.map((g, imgIdx) => (
                         <div key={imgIdx} className={styles.imagePreviewSmall}>
                           <Image src={g.url} alt={`Section ${index + 1} - ${imgIdx + 1}`} width={140} height={140} style={{ width: '100%', height: 'auto' }} />
